...
def learn(self, samples):
	...
	booleanPredicatesFeatures =  createBooleanPredicate(self.symbolicIntVariables)
...
if __name__ == '__main__':
	...
	learner.setVariables(intVariablesTemp, boolVariablesTemp)
