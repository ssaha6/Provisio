...
{
    /*
     * Source Code taken from https://github.com/dotnet/corefx/blob/master/src/Common/src/CoreLib/System/Collections/Generic/Dictionary.cs 
     */
    ...
    public class Dictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue>, ISerializable/*, IDeserializationCallback*/
    {
        ...
        {
            if (capacity < 0) throw new ArgumentOutOfRangeException("nameof(capacity)", capacity, "Non-negative number required");
        ...
        public Dictionary(IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey> comparer) : this(dictionary != null ? dictionary.Count : 0, comparer)
        {
            if (dictionary == null)
            {
                throw new ArgumentNullException("nameof(dictionary)", "dictionary should not be null");
            }
        ...
        public virtual void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            info.AddValue(ComparerName, DictionaryHashHelpers.GetEqualityComparerForSerialization(comparer), typeof(IEqualityComparer<TKey>));
        ...
        object IDictionary.this[object key]
        {
            ...
            set
            {
                ...
                try
                {
                    ...
                    {
                        throw new ArgumentException("wrong type " + typeof(TValue), "nameof(value)");
                    }
                }
                catch (InvalidCastException)
                {
                    throw new ArgumentException("wrong type " + typeof(TKey), "nameof(key)");
                }
            }
        }
            ...
            IDictionaryEnumerator
        {
            ...
            public bool MoveNext()
            {
                ...
                {
                    throw new InvalidOperationException("Enum version changed");
                }
        ...
        [DebuggerDisplay("Count = {Count}")]
        [Serializable]
        public sealed class KeyCollection : ICollection<TKey>, ICollection, DataStructures.Utility.IReadOnlyCollection<TKey>
        {
            private Dictionary<TKey, TValue> dictionary;
            ...
            public void CopyTo(TKey[] array, int index)
            {
                ...
                {
                    throw new ArgumentException("SR.ArgumentOutOfRange_Index");
                }
        ...
        [DebuggerDisplay("Count = {Count}")]
        [Serializable]
        public sealed class ValueCollection : ICollection<TValue>, ICollection,DataStructures.Utility.IReadOnlyCollection<TValue>
        {
            private Dictionary<TKey, TValue> dictionary;
