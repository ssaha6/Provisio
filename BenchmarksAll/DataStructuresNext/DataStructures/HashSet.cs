...
namespace DataStructures
{
        ...
        /// </summary>
        /* 
        * Source Code Adapted From: https://github.com/dotnet/corefx/blob/master/src/System.Collections/src/System/Collections/Generic/HashSet.cs
        */
            ...
            /*public virtual void OnDeserialization(Object sender)
        {
            ...
            public void CopyTo(T[] array, int arrayIndex, int count)
            {
                ...
                if (arrayIndex < 0)
                {
                    throw new ArgumentOutOfRangeException("nameof(arrayIndex)", arrayIndex,"should be non negative");
                }

                // also throw if count less than 0
                if (count < 0)
                {
                    throw new ArgumentOutOfRangeException("nameof(count)", count, "should be non negative");
                }
            ...
            public struct Enumerator : IEnumerator<T>, IEnumerator
            {
                ...
                public bool MoveNext()
                {
                    ...
                    {
                        throw new InvalidOperationException("Different version of HashSet");
                    }
            ...
            public string ToStringForInt()
            {
                    ...
                    //Assumes T(int) has  ToString()
                    string ret = "{";
                    /*for (int i = 0; i < _count; i++)
                    {
                        ret += _slots[i].value.ToString() + " ";
                    }*/
